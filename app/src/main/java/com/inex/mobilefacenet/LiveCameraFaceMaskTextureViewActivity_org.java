 ...
 */
public class LiveCameraFaceMaskTextureViewActivity_org extends Activity implements TextureView.SurfaceTextureListener {
    private final String TAG = "LiveCameraTViewActivity";
    private TextureView cam0TextureView;
    private ImageView cam0FaceImageView;
    private Bitmap bitmap;
    private long start = System.currentTimeMillis();
    private long end = System.currentTimeMillis();
    private ImageFaceAndMaskDetection imageFaceAndMaskDetection;
    private SurfaceTexture mSurfaceTexture;
    private TextView cam0StatusTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cam0TextureView = findViewById(R.id.live_cam0_TextureViewActivity);
        cam0StatusTextView = findViewById(R.id.faceMask_cam0_status_textView);
        cam0FaceImageView = findViewById(R.id.face_cam0_ImageView);
        cam0TextureView.setSurfaceTextureListener(this);

//        applyMirroringOnCamera(textureView);
        cam0FaceDetector();
    }

    private void cam0FaceDetector() {
        ...
        imageFaceAndMaskDetection.setCustomObjectListener(new ImageFaceAndMaskDetection.DetectionPhaseListener() {
            ...
            public void onFaceDetected(Bitmap bitmapOfDetectedFace) {
                runOnUiThread(() -> runOnUiThread(() -> cam0FaceImageView.setImageBitmap(bitmapOfDetectedFace)));
            ...
            public void onNoFaceDetected(Bitmap bitmapOfDetectedFace) {
                if (wasPreviousDetectionWithFace)
                    runOnUiThread(() -> runOnUiThread(() -> cam0FaceImageView.setImageResource(R.drawable.no_face)));
            ...
            public void onResultOfMaskDetection(Classifier.Recognition classRecognition) {
                if (classRecognition != null) {
                    runOnUiThread(() -> {
                        cam0StatusTextView.setTextColor(classRecognition.getColor());
                        cam0StatusTextView.setText(classRecognition.toString());
                    });
                }
            }
        });
    ...
    */
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        bitmap = cam0TextureView.getBitmap();
...
//---------------testing this-----------
        ...
        mSize = MyUtil.getOptimalSize(parameters.getSupportedPreviewSizes(), cam0TextureView.getWidth(), cam0TextureView.getHeight());
